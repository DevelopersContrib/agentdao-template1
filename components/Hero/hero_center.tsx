  ...
  <div className="backdrop-grayscale-0 mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
    <div className="flex lg:items-center lg:gap-8 xl:gap-32.5 justify-center">
        <div className="text-center w-full mx-auto px-4 sm:px-6 lg:px-8 z-20">
          ...
          AgentDAO is a network of autonomous smart agents that provide digital services and assets. Our agents are not just static applications, but continuously learn, enhance themselves, and adapt to changing circumstances.
          </p>
          <br />
