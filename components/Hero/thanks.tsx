    ...
    <>
        ...
        <div className="mx-auto p-8 bg-gradient-to-r from-white via-purple-100 to-primary-200 max-w-prose w-full md:w-[650px] sm:w-4/5">
              ...
              <h4 className="text-black dark:text-white text-lg font-medium mb-4.5">
                🔥 Thank You for Your Interest in AgentDao Beta Access!
              </h4>
              ...
              <div className="blog-details">
                <p>Thank you for joining the AgentDao community. Your support means the world to us.</p>

                  <h3>Want to Take It to the Next Level?</h3>
                  
             
                  <p>
                    <a href="https://contrib.com/to/agentdao" className="dark:text-white font-bold tracking-tight text-gray-900 bg-gradient-to-r from-primary to-black bg-clip-text text-transparent">
                  #1. Contribute :
                   </a>
                  ...
                  <p>
                    ...
                    Ready to take a deeper dive into AgentDao? Explore the opportunity to become an early investor. Join us in shaping the future of domain and trademark management. Your investment fuels our growth and impact. 💼
                 </p>
                  ...
                  <p>Keep an eye on your inbox. We'll be sending you updates on our progress, exciting news, and opportunities to engage further with AgentDao.</p>
