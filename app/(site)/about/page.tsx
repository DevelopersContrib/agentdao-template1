         ...
         <div  className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div  className="mt-10 lg:mt-0">
              ...
              <span className="capitalize">{domain}</span> is a member of <a href="https://agentdao.com">AgentDao</a>. 
               ...
               <p  className="mb-8 text-base text-body-color dark:text-dark-6">
               Join us on this exhilarating journey to reshape the digital landscape. Become a part of AgentDAO, where innovation knows no bounds, and the spirit of collaboration propels us towards a future where the extraordinary becomes the everyday.
               </p>
               <a
                  href="/betaapply"
